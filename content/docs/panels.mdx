---
title: Panels
description: Reference for all 19 panels available in the PolyWorld dashboard.
---
...
PolyWorld uses a modular panel system. Each panel can be shown/hidden, reordered via drag-and-drop, and resized. Panels are arranged in a **right sidebar** (max 2 columns) and a **bottom bar** (max 3 columns).
