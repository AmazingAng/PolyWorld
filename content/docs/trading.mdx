---
title: Trading Guide
description: How to connect your wallet and trade on Polymarket through PolyWorld.
---
...
<Callout type="warn">
**Real money trading.** PolyWorld connects to the live Polymarket exchange. Orders are irreversible once filled. Start small until you're comfortable with the flow.
</Callout>
...
<Steps>
  <Step>
    ...
    **Why a proxy wallet?** Polymarket doesn't trade directly from your MetaMask. Instead, it creates a special smart contract wallet (Gnosis Safe) tied to your address. All your USDC and positions live in this proxy wallet. This is standard for all Polymarket users.
    ...
    Once you've logged in on polymarket.com at least once, your proxy wallet is created and PolyWorld can detect it automatically.
  </Step>
  ...
  <Step>
    ...
    <Tabs items={["Via Polymarket (Easiest)", "Manual Bridge"]}>
      ...
      <Tab value="Manual Bridge">
        ...
        2. You can find your proxy address in the PolyWorld wallet panel after connecting
  ...
  <Step>
    ...
    If this is your first trade through PolyWorld, click **"Approve Tokens"**.
...
<Cards>
  ...
  <Card title="Is this the same as trading on polymarket.com?">
    **Yes.** PolyWorld connects to the same Polymarket CLOB exchange. Your positions, balances, and orders are identical whether you trade from polymarket.com or PolyWorld.
  </Card>
...
<Cards>
  ...
  <Card title="❌ Wrong network">
    Click the network warning in the wallet panel — PolyWorld will auto-switch you to Polygon.
  </Card>
</Cards>
